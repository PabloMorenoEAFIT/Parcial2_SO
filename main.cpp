...
void mostrarMenu() {
    ...
    std::cout << "5. Detectar rostros en la imagen" << std::endl;
...
void ejecutarYCompararFunciones(const std::string& nombreFuncion, 
    ...
    std::cout << "Aceleración: " << speedup << "x" << std::endl;
    std::cout << "-----------------------------------------" << std::endl;
}
    ...
    do {
        ...
        switch(opcion) {
            ...
            case 4:
                ...
                break;
            case 5:
                ejecutarYCompararFunciones("Detección de rostros", 
                    ProcesadorImagen::procesarImagenConDeteccionDeRostrosSinOpenMP, 
                    ProcesadorImagen::procesarImagenConDeteccionDeRostros, 
                    archivo);
                break;
            case 0:
